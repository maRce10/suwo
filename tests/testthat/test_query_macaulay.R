...
test_that("search Glaucis dohrnii images", {
  ...
  df1 <- query_macaulay(species = 'Glaucis dohrnii', format =  "image", path = tempdir())
...
test_that("paging by date", {
  ...
  df1 <- query_macaulay(species = 'Calypte costae', format = "image", path = tempdir(), dates = c(2022, 2024, 2025))
