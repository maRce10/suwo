...
#Search for all sound media files

base.srch.pth <- paste0("https://api.gbif.org/v1/occurrence/search?dataset_key=8a863029-f435-446a-821e-275f4f641165&media_type=Sound&limit=300")


#Specific search for species

base.srch.pth <- paste0("https://api.gbif.org/v1/occurrence/search?dataset_key=8a863029-f435-446a-821e-275f4f641165&media_type=Sound&limit=300&species=", term)

#initialize search
get_ids <- as.array(rjson::fromJSON(file = paste0(base.srch.pth)))
