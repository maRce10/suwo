...
[![Codecov test coverage](https://codecov.io/gh/maRce10/suwo/graph/badge.svg)](https://app.codecov.io/gh/maRce10/suwo)
<!-- badges: end -->
...
:warning:**THE PACKAGE IS ON AN EARLY DEVELOPMENTAL STAGE AND WILL BE MODIFIED FREQUENTLY.**:warning:
...
Take a look at the [package vignette](./articles/suwo.html) for an overview of the main features of the packages.
