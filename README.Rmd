...
Finding data using [suwo](https://marce10.github.io/suwo/) follows a basic 
sequence. The following diagram illustrates this workflow and the main functions
involved:

<center><img src="./vignettes/workflow_diagram.png" alt="suwo workflow diagram" width="100%"></center>
