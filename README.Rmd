...
[![Last-changedate](https://img.shields.io/badge/last%20change-`r gsub('-', '--', Sys.Date())`-yellowgreen.svg)](/commits/main) 
  [![Codecov test coverage](https://codecov.io/gh/maRce10/suwo/branch/main/graph/badge.svg)](https://app.codecov.io/gh/maRce10/suwo?branch=main)
...
[suwo](https://marce10.github.io/suwo) offers functions for critical steps in the acquisition of data necessary to develop methods that require a large amount of data.
...
Take a look at the [package vignette](https://marce10.github.io/suwo/articles/suwo.html) for an overview of the main features of the packages.
