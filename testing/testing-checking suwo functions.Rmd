...
options(all_data = FALSE)

xc_adf <- query_xenocanto(term = 'Phaethornis anthophilus')

wa_adf <- query_wikiaves(term = 'Glaucis dohrnii', format = "sound")
 
gb_adf <- query_gbif(term = 'Glaucis dohrnii', format = "image")

in_adf <- query_inaturalist(term = 'Agalychnis lemur', format = "image")
