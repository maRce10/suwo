...
pkgs <- c("remotes", "curl", "RCurl", "jsonlite", "crayon", "devtools", "leaflet", "maps", "pkgcheck", "pkgstats", "testthat", "styler", "cli", "beepr")
...
a <- rbind(xc_adf, wa_adf, gb_adf, in_adf, ml_adf)


unique(a$file_extension)
...
View(gb_adt[is.na(gb_adt$file_extension),])

gb_adt$occurrenceid[is.na(gb_adt$file_extension)]
```
