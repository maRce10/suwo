...
df1 <- query_macaulay(term = 'Calypte costae', type = "image", path = tempdir(), dates = c(1976, 2020, 2022, 2024, 2025, 2026))
...
wa_adf <- query_wikiaves(term = 'Glaucis dohrnii', type = "sound")
 
gb_adf <- query_gbif(term = 'Glaucis dohrnii', type = "image")

in_adf <- query_inaturalist(term = 'Agalychnis lemur', type = "image")
 
ml_adf <- query_macaulay(term = 'Glaucis dohrnii', type = "sound", path = tempdir())
...
wa_adt <- query_wikiaves(term = 'Glaucis dohrnii', type = "sound")
 
gb_adt <- query_gbif(term = 'Glaucis dohrnii', type = "image")

in_adt <- query_inaturalist(term = 'Agalychnis lemur', type = "image")
 
ml_adt <- query_macaulay(term = 'Glaucis dohrnii', type = "sound", path = tempdir())
