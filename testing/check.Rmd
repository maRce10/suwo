---
title: "testing-checking suwo function feb-2023"
...
#uninstall suwo 
```{r reinstall suwo from github, eval=F}
...
x <- c( "devtools", "pkgdown", "spelling", "maRce10/suwo")
...
# only build manual 
setwd(".")
system("R CMD Rd2pdf ./R\ package\ testing/suwo/suwo")
