...
metadata_list$t_rufiventris <- metadata_list$t_tricolor <- NULL
...
subset_metadata(vignette_metadata$h_harpyja, select = suwo:::.format_query_output(only_basic_columns = TRUE))
...
subset_metadata(vignette_metadata$p_lotor, select = suwo:::.format_query_output(only_basic_columns = TRUE))
...
subset_metadata(vignette_metadata$p_striigularis, select = suwo:::.format_query_output(only_basic_columns = TRUE))
...
subset_metadata(vignette_metadata$t_tricolor, select = suwo:::.format_query_output(only_basic_columns = TRUE))
```
...
subset_metadata(vignette_metadata$a_hahneli, select = suwo:::.format_query_output(only_basic_columns = TRUE))
```
...
old_c_eisentrauti <- subset_metadata(c_eisentrauti, subset = date <= "2024-12-31" | is.na(date))
...
azam_gbf <- query_gbif(species = "Amanita zambiana", format = "image")
