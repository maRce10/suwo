...
The suwo package is designed to simplify the retrieval of nature media across multiple online biodiversity databases. This vignette provides an overview of the package’s core querying functions, the searching and downloading of media files, and the compilation of metadata from various sources. 
...
kableExtra::kable_styling(
  kableExtra::kable(head(ectophylla_gbif, 2), caption = "First 2 rows from GBIF"),
  bootstrap_options = c("striped", "hover"),
  full_width = FALSE
)

kableExtra::kable_styling(
  kableExtra::kable(head(ectophylla_inat, 2), caption = "First 2 rows from iNaturalist"),
  bootstrap_options = c("striped", "hover"),
  full_width = FALSE
)

kableExtra::kable_styling(
  kableExtra::kable(head(ectophylla_xc, 2), caption = "First 2 rows from Xeno-Canto"),
  bootstrap_options = c("striped", "hover"),
  full_width = FALSE
)
